...
# def Domestication_complex_demography_cache(params, ns, pts):
    
#     new1,new2,new3,ne1d,ne2d,ne3d,T1,T2,T3,md1,md2,md3,mw1,mw2,mw3,gamma1,gamma2 = params

#     xx = Numerics.default_grid(pts)
    
#     phi = PhiManip.phi_1D(xx, gamma=gamma1) # phi for the eq. ancestral population
    
#     phi = PhiManip.phi_1D_to_2D(xx, phi)
#     phi = Integration.two_pops(phi, xx, T1, new1, ne1d, m12=md1, m21=mw1, gamma1=gamma1, gamma2=gamma2) #time and size of the domesticated pop bottleneck 
#     phi = Integration.two_pops(phi, xx, T2, new2, ne2d, m12=md2, m21=mw2, gamma1=gamma1, gamma2=gamma2) #time and size of the domesticated pop recovery 
#     phi = Integration.two_pops(phi, xx, T3, new3, ne3d, m12=md3, m21=mw3, gamma1=gamma1, gamma2=gamma2) #time and size of the domesticated pop recovery 
...
#     nu1,nuPre,nu2,TPre,T,T1,m12,m21,gamma1,gamma2 = params
...
#     phi = Integration.two_pops(phi, xx, T, nu1, nuPre, m12=m21, m21=m12, gamma1=gamma1, gamma2=gamma2)
#     phi = Integration.two_pops(phi, xx, T1, nu1, nu2, m12=m21, m21=m12, gamma1=gamma1, gamma2=gamma2)
#     fs = Spectrum.from_phi(phi, ns, (xx,xx))
#     return fs
