...
lower_bound=[0.01,0.01,0,  1,0,0,0]
upper_bound=[10,  200, 1,200,1,1,1]

fixed_params=[None,None,None,20,None,None,None]
...
try:
	fid = open('../results/dadi_outputs/Bootstraps/sim_'+migration+'-'+possel+'-'+change+'-'+site+'_boot.'+iteration+'_nsyn_fits.txt','a')
except:
	fid = open('../results/dadi_outputs/Bootstraps/sim_'+migration+'-'+possel+'-'+change+'-'+site+'_boot.'+iteration+'_nsyn_fits.txt','w')
