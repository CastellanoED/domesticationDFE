...
# demography_complex_domestication = new_models.Domestication_complex_demography
...
# with open('../results/dadi_outputs/sim_'+migration+'-'+possel+'-'+change+'.2d.'+site+'_best_fit.txt', newline = '') as best_demo:   
