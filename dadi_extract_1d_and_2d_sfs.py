...
dd = dadi.Misc.make_data_dict_vcf(datafile, '../results/Wild_Domesticated_individuals.txt')
...
new_ns = [20, 20]
dd_subsample = dadi.Misc.make_data_dict_vcf(datafile, '../results/Wild_Domesticated_individuals.txt', subsample={'Domesticated': ns[0]//2, 'Wild': ns[1]//2})
...
new_ns = [20]
dd_subsample = dadi.Misc.make_data_dict_vcf(datafile, '../results/Wild_Domesticated_individuals.txt')
fs_subsample = dadi.Spectrum.from_data_dict(dd_subsample, pop_ids, new_ns)
